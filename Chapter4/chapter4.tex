...
%     \includegraphics[width=0.32\linewidth]{Chapter4/coSSC_master_beta0.png}
%   }
%   \subfloat[]{
%     \label{fig:cap5_gammavol}
%     \includegraphics[width=0.32\linewidth]{Chapter4/coSSC_master_gamma_vol.png}
%   }
%   \caption{(a) Shows the $\beta^0$ Image of Amazon area and (b) shows the Coherence Image of Amazon area.}
% \end{figure}
