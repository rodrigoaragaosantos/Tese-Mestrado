...
\begin{abstract}
\noindent
\input{Cap0/resumo.tex}
\end{abstract}

% Abstract
\begin{englishabstract}
\noindent
\input{Cap0/abstract.tex}
\end{englishabstract}
...
\input{Cap0-Introducao/introducao_v2.tex}

\chapter{Theoretical Background}
\label{cap:bibliographic_review}
\input{Cap1-Bib-Review/cap1.tex}

\chapter{Materials and Methods}
\label{cap: methods_and_materials}
\input{Cap2-Methods/cap2.tex}

\chapter{Results}
\label{cap: results}
\input{Cap3-Results/cap3.tex}
